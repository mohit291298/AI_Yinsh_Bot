		...
		for(int k=0;k<(blist.size());k++){
			...
			for(int i1=0;i1<11;i1++){
				...
				cout<<"\n";
							...
							cout<<(n->children[n->children.size()-1])->p<<"\n";
							cout<<(n->children[n->children.size()-1])->visited<<"\n";
							cout<<(n->children[n->children.size()-1])->move<<"\n";
							cout<<"after extend after\n";
